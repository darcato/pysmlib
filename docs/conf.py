...
exclude_patterns = [u'docs', 'Thumbs.db', '.DS_Store']
...
#html_title = None
html_title = 'Epics Finite State Machines for Python'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = 'PySmlib'
...
latex_documents = [
    (master_doc, 'pysmlib.tex', u'pysmlib Documentation',
...
man_pages = [
    (master_doc, 'pysmlib', u'pysmlib Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pysmlib', u'pysmlib Documentation',
     author, 'pysmlib', 'One line description of project.',
     'Miscellaneous'),
]
